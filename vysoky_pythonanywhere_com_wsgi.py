...
# web application at http://vysoky.pythonanywhere.com/
...
#import sys
#
#path = '/home/vysoky/path/to/my/app
...
#import sys
#
## assuming your django settings file is at '/home/vysoky/mysite/mysite/settings.py'
## and your manage.py is is at '/home/vysoky/mysite/manage.py'
#path = '/home/vysoky/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
...
#import sys
#
## The "/home/vysoky" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/vysoky/myproject"
#path = '/home/vysoky/path/to/flask_app_directory'
#if path not in sys.path:
#    sys.path.append(path)
#
